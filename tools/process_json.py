...
class ProcessJSON:
    ...
    def process(file_path: str, output_folder: str, remove_invalid_name_characters: bool, verbose: bool):
        ...
        ProcessJSON._process_items(json_data,Path(file_path).parent.__str__(),output_folder)
    ...
    def _process_sprite(base_path: str, sprite_name: str, output_folder: str):
        ...
        shutil.copy(sprite_path,Path(output_folder).joinpath("graphics",sprite_path.name))
